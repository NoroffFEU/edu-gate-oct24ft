To use login form type in the email and password under:
...
The page dashboard-student.html is not made yet, you will see an empty page, but the process works.
